...
class WebDriverIO extends Helper {
  ...
  */
  ...
  openSelect2(selector) {
    selector = this.withStrictLocator(selector);
    this.executeScript(function(selector) {
  ...
  selectOptionForSelect2(selector, option) {
    selector = this.withStrictLocator(selector);
    this.executeScript(function(selector, option) {
  ...
  _optionIsSelectedForSelect2(selector, optionText) {
    let selectedValue;
    selector = this.withStrictLocator(selector);
    selectedValue = this.executeScript(function(selector, optionText) {
